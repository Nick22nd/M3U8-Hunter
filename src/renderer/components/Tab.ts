...
if (!document)
  throw new Error('electron-tabs module must be called in renderer process')
...
class TabGroup extends HTMLElement {
  ...
  constructor() {
    ...
    this.isReady = false
    console.log('tab-button new: ', this.getAttribute('new-tab-button'))
    // Options
    this.options = {
      closeButtonText: this.getAttribute('close-button-text') || '&#215;',
      defaultTab: { title: 'New Tab', active: true },
      newTabButton: !!this.getAttribute('new-tab-button') === true || true,
